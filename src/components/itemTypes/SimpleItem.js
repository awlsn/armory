...
function CharmComponents(props) {
  const { item } = props;
  return (

        <div className="item row" data-type={item.props[0][1]}>

            <div className="row" id={item.index}>

                <div className="item-left four columns">
                    <span className="item-graphic "><img alt="" src={`/static/images/items/${item.imageFile}`} /></span>
...
export default CharmComponents;
